      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-8 justify-center">
        ...
        <div className="image-container">
          <img
            src={profileImage}
            alt="Profile"
            className="w-72 h-90 rounded-lg object-cover shadow-lg"
          />
        </div>
      </div>
    </section>
