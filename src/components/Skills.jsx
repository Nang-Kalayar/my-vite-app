  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        {
          name: "Angular",
          icon: <FaAngular className="w-4 h-4 text-[#47A248]" />,
        },
        {
          name: "REST APIs",
    ...
    
    {
      ...
      skills: [
        ...
        {
          name: "Postman",
          icon: <img src="/postman.svg" className="w-4 h-4" alt="Postman logo" />,
        },
        {name:"WebStorm",icon:<FcWorkflow className="w-4 h-4 text-[#000000]" />},
        ...
        {name:"IntelliJ IDEA",icon:<FcWorkflow className="w-4 h-4 text-[#000000]" />}
      ],
    },
  ];
