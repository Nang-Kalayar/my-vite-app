...
export default function Hero() {
  const words = [
    ...
    "React Developer & Cloud Enthusiast",
    "NodeJS Developer & DevOps Enthusiast",
    "Learning Spring Framewrok",
    "GitHub for DevOps Enthusiast",
  ];

  const [code] = useState(`
const profile = {
    name: 'Nang Kalyar Htwe',
    title: 'Full-Stack Developer |Backend Enthusiast | Problem Solver',
    skills: [
        'Jave',,'React', 'NextJS', 'Redux', 'NodeJS', 'Tailwindcss', 'Spring framework',
        'Spring Boot', 'RESTful APIs', 'Microservices',
        'Angular', 'Git','MySQL',  'TypeScript',
        'GraphQL',
    ],
    hardWorker: true,
    quickLearner: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Java lover 🚀 |  Learning  frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Nang-Kalayar"
