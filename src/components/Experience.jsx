...
const ExperienceSection = () => {
  const experiences = [
    
    {
      ...
      company: "Myanmar Miracle Tech Co., Ltd.",
      period: "for 3-months(internship)",
      description:
        "Assisted in building ,testing and optimizing user interfaces with a focus on responsive and interactive designs.",
    },
    {
      icon: Code2,
      title: "Junior Software Developer",
      company: "SoftStar Tech Co., Ltd.",
      period: "for 3-months",
      description:
        "Contributed to developing Java  and enhancing framework functionalities.",
    },
  ];
